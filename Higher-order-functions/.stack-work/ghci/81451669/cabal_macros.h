...
/* package Higher-order-functions-0.1.0.0 */
#ifndef VERSION_Higher_order_functions
#define VERSION_Higher_order_functions "0.1.0.0"
#endif /* VERSION_Higher_order_functions */
#ifndef MIN_VERSION_Higher_order_functions
#define MIN_VERSION_Higher_order_functions(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Higher_order_functions */
...
#define CURRENT_COMPONENT_ID "Higher-order-functions-0.1.0.0-BkV1Uk5pCiCCZZA58HABXf-Higher-order-functions"
