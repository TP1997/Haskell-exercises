...
/* package arvioinnit-0.1.0.0 */
#ifndef VERSION_arvioinnit
#define VERSION_arvioinnit "0.1.0.0"
#endif /* VERSION_arvioinnit */
#ifndef MIN_VERSION_arvioinnit
#define MIN_VERSION_arvioinnit(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_arvioinnit */
...
#define CURRENT_COMPONENT_ID "arvioinnit-0.1.0.0-BkPmkFqLca4Jhr4kxuUawi-arvioinnit"
